/**
 * Web App for Lab 7: Pointers & Memory Management
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('Lab 7: พอยน์เตอร์และการจัดการหน่วยความจำพลวัต')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab C 7 Submissions";
    ...
    var folderName = "Lab C 7 Attachments";
    ...
    var codeKeywords = ["malloc","free","sizeof","sum","scanf","printf"];
    ...
    var isB1Correct = ["malloc(sizeof(int))","malloc(sizeof (int))","malloc(4)"].indexOf(b1) !== -1;
    if (isB1Correct) blankCorrectCount++;
    

    var b2 = (data.blank2 || "").toString().trim();
    var isB2Correct = ["free(p)","free( p )"].indexOf(b2) !== -1;
