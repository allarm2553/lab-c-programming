/**
 * Web App for Lab 2: Operators & Expressions
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('Lab 2: ตัวดำเนินการและการประเมินนิพจน์')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab C 2 Submissions";
    ...
    var folderName = "Lab C 2 Attachments";
