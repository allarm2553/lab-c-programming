/**
 * Web App for Lab 8: Structures & Unions
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('Lab 8: โครงสร้างข้อมูลกำหนดเอง (Structures & Unions)')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab C 8 Submissions";
    ...
    var folderName = "Lab C 8 Attachments";
    ...
    var codeKeywords = ["struct","\\.|\\->","scanf","printf","float|int"];
    ...
    var isB1Correct = ["struct User"].indexOf(b1) !== -1;
    if (isB1Correct) blankCorrectCount++;
    

    var b2 = (data.blank2 || "").toString().trim();
    var isB2Correct = ["user1.username"].indexOf(b2) !== -1;
