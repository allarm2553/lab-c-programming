/**
 * Web App for Lab 6: Arrays & Strings
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('Lab 6: อาร์เรย์และสตริง (Arrays & Strings)')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab C 6 Submissions";
    ...
    var folderName = "Lab C 6 Attachments";
    ...
    var codeKeywords = ["stds","score","average","sum","for"];
    var q1Keywords = ["1 มิติ","2 มิติ","แถว","คอลัมน์","ตาราง"];
    var q2Keywords = ["\\\\0","null","จบ","array","character"];
