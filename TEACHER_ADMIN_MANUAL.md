...
> [!TIP]
> 📖 **ต้องการดูวิธีการเชื่อมต่อ Google Sheets หรือการส่งลิงก์ให้นักเรียนทำใบงาน?**
> กรุณาดูที่ **[คู่มือการเชื่อมต่อ Google Sheets และการแชร์ลิงก์ให้นักเรียน (TEACHER_GAS_SETUP_MANUAL.md)](./TEACHER_GAS_SETUP_MANUAL.md)**
...
### วิธีที่ 1: กดปุ่ม "ผู้เรียนคนใหม่ (รีเซ็ต)" บนหน้าเว็บโดยตรง (เร็วและสะดวกที่สุด ⭐ แนะนำ)
1. บนหน้าเว็บใบงาน ให้กดปุ่ม **"🔄 ผู้เรียนคนใหม่ (รีเซ็ต)"** ที่อยู่บริเวณปุ่มคำสั่งด้านล่าง หรือในแถบแจ้งเตือนล็อกหน้าเว็บ
2. หน้าต่างยืนยันความปลอดภัยจะปรากฏขึ้น ให้กด **"ยืนยันล้างข้อมูล"**
3. ✅ ระบบจะล้างชื่อ รหัส โค้ด และไฟล์แนบของคนก่อนหน้าออกทั้งหมด พร้อมปลดล็อกฟอร์มให้ผู้เรียนคนใหม่เริ่มทำได้ทันทีโดยไม่ต้องเปิด Incognito

---

### วิธีที่ 2: เปิดใน "หน้าต่างไม่ระบุตัวตน" (Incognito Window)
...
### วิธีที่ 3: ล้างแคชหน้าเว็บ (Clear Site Storage)
