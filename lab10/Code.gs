/**
 * Web App for Lab 10: String Functions
...
function doGet(e) {
  return HtmlService.createTemplateFromFile('index')
    .evaluate()
    .setTitle('Lab 10: การใช้งานฟังก์ชันจัดการสตริง (String Functions)')
...
function submitLabData(data) {
  try {
    ...
    var sheetName = "Lab C 10 Submissions";
...
ระบบอนุญาตให้ส่งได้เพียง 1 ครั้งเท่านั้น (หากต้องการส่งใหม่ กรุณาติดต่ออาจารย์ผู้สอน)"
    ...
    var folderName = "Lab C 10 Attachments";
    ...
    var codeKeywords = ["string\\.h","fgets","strlen","strstr|strcmp|strncpy","printf"];
    ...
    var isB1Correct = ["strncpy"].indexOf(b1) !== -1;
    if (isB1Correct) blankCorrectCount++;
    

    var b2 = (data.blank2 || "").toString().trim();
    var isB2Correct = ["strncat"].indexOf(b2) !== -1;
