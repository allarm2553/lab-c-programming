...
3. **ดาวน์โหลดหรือคัดลอกโค้ด Backend (`Code.gs`):**
   - **วิธีที่ 1 (สะดวกที่สุด — คลิกเดียวจากหน้าเว็บ):**
     - เปิดหน้าใบงานแล็บนั้นๆ จะมีกล่องตั้งค่าด้านบน ให้กดปุ่ม **"📥 โหลด Code.gs"** เพื่อดาวน์โหลดไฟล์ หรือกดปุ่ม **"📋 คัดลอก Code.gs"** เพื่อคัดลอกโค้ดลง Clipboard ทันที
     - หรือเปิดหน้าแรก กดเมนู **"🔗 ลิงก์ส่งคะแนน (14 Labs)"** จะมีปุ่ม **"📥 Code.gs"** และ **"📋 คัดลอก"** ครบทั้ง 14 แล็บในที่เดียว
   - **วิธีที่ 2:** เปิดดูไฟล์ `Code.gs` จากโฟลเดอร์ของแล็บนั้นๆ บน GitHub
   - ในหน้าต่าง Google Apps Script ให้ลบโค้ดเดิมออกทั้งหมด แล้วกดวาง (`Ctrl + V`) โค้ดที่คัดลอกมา จากนั้นกดบันทึก 💾 (`Ctrl + S` หรือ `Cmd + S`)
